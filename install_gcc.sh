...
$GCC_PATH/configure --prefix=${INTSTALL_PATH} --with-plugin-ld=/usr/local/bin/ld-plugin  --enable-lto --enable-languages=c,c++ --disable-werror --disable-bootstrap --disable-multilib
